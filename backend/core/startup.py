...
READER_PERMISSIONS_LIST = [
    ...
    "view_businessservice",
    "view_serviceassetlink",
    "view_continuityplan",
    "view_continuityplantest",
    "view_assetrecoveryprocedure",
    "view_assetclass",
...
ANALYST_PERMISSIONS_LIST = [
    ...
    "add_businessservice",
    "view_businessservice",
    "change_businessservice",
    "delete_businessservice",
    "add_serviceassetlink",
    "view_serviceassetlink",
    "change_serviceassetlink",
    "delete_serviceassetlink",
    "add_continuityplan",
    "view_continuityplan",
    "change_continuityplan",
    "delete_continuityplan",
    "add_continuityplantest",
    "view_continuityplantest",
    "change_continuityplantest",
    "delete_continuityplantest",
    "add_assetrecoveryprocedure",
    "view_assetrecoveryprocedure",
    "change_assetrecoveryprocedure",
    "delete_assetrecoveryprocedure",
    "view_assetclass",
    "view_assetcapability",
    # campaigns,
    "view_campaign",
